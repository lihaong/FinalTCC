...
@csrf
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" name='id_item' value="{{ Session::get('id') }}" id="id">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="nama" class="col-sm-2 col-form-label">Nama Item</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='nama_item' value="{{ Session::get('nama') }}" id="nama">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="harga" class="col-sm-2 col-form-label">Harga Item</label>
            <div class="col-sm-10">
                <input type="number" class="form-control" name='harga_item' value="{{ Session::get('harga') }}" id="harga">
            </div>
        </div>
        <div class="mb-3 row">
